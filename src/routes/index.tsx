        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-16 pt-12 sm:px-6 sm:pt-20 lg:pb-24">
          <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_1fr]">
            <div style={{ animation: "fade-up 0.5s both" }}>
              ...
              {/* Headline — smaller, balanced lines (3-4 words per line) */}
              <h1 className="mt-5 font-display text-[28px] font-bold leading-[1.15] tracking-tight text-foreground sm:text-4xl lg:text-[44px]">
                Crack <span className="text-primary">JEE, NEET</span>,<br />
                boards &amp; competitive exams<br />
                with exam-grade mocks.
              </h1>
              ...
              <div className="mt-7 flex flex-wrap items-center gap-3">
                ...
                >
                  <Newspaper className="h-4 w-4 text-primary" /> Daily News
                </Link>
              </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:px-6">
        <div className="relative overflow-hidden rounded-[28px] bg-gradient-to-br from-[oklch(0.45_0.27_265)] via-[oklch(0.42_0.27_268)] to-[oklch(0.32_0.22_270)] p-7 text-background shadow-elevated sm:p-12">
          ...
          <div className="relative max-w-2xl">
            ...
            <h3 className="mt-3 font-display text-3xl font-bold leading-[1.1] sm:text-5xl">
              Install AdhyayX and start<br className="hidden sm:block" /> learning with confidence.
            </h3>
            <p className="mt-5 max-w-lg text-sm text-background/85 sm:text-base">
      ...
      <section id="faq" className="mx-auto max-w-3xl px-5 pb-20 sm:px-6">
        ...
        <FAQList
          items={[
            ...
            { q: "Where do I read current affairs & news?", a: "Open the News tab — pick any date and you'll get that day's affairs digest plus the latest news in one screen." },
          ]}
        />
      </section>
    ...
    <div className="mt-8 space-y-3">
      {items.map((item, i) => {
        ...
        return (
          <div
            key={item.q}
            className={`overflow-hidden rounded-2xl border-2 bg-card transition-all ${
